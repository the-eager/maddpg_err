...
def get_args():
    ...
    parser.add_argument("--time-steps", type=int, default=150000, help="number of time steps")
    ...
    parser.add_argument("--evaluate-rate", type=int, default=5000, help="how often to evaluate model") # 每1万次评估一下模型
